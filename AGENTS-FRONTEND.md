...
This repository contains an Angular 18 frontend application for a PFE project (LearnAI).  
...
- pages/ → full page components (dashboard, auth, admin)
- shared/components/ → reusable UI components
- shared/models/ → TypeScript interfaces and enums
- shared/services/ → HTTP service calls
- shared/guards/ → route guards
- core/ → interceptors, constants, app-wide config
